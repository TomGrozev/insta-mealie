  ...
  describe "CTA matrix per stage" do
    ...
    test "llm_format/api_error: retry only" do
      {id, _} =
        start_failed_job(
          mealie: InstaMealie.MealieStub,
          llm: InstaMealie.Test.LlmFormatErrorDouble,
          ytdlp: InstaMealie.YtDlpStub
        )
    ...
    test "mealie_import/validation: dead row (no CTAs)" do
      {id, _} =
        start_failed_job(
          mealie: InstaMealie.Test.MealieValidationDouble,
          llm: InstaMealie.LlmStub,
          ytdlp: InstaMealie.YtDlpStub
        )
    ...
    test "mealie_import/network: retry shown (network is retryable)" do
      {id, _} =
        start_failed_job(
          mealie: InstaMealie.Test.MealieNetworkDouble,
          llm: InstaMealie.LlmStub,
          ytdlp: InstaMealie.YtDlpStub
        )
    ...
    test "mealie_import/auth: retry shown (auth is retryable)" do
      {id, _} =
        start_failed_job(
          mealie: InstaMealie.Test.MealieAuthDouble,
          llm: InstaMealie.LlmStub,
          ytdlp: InstaMealie.YtDlpStub
        )
