defmodule InstaMealie.Test.MealieReviewZeroCandidateDouble do
  @moduledoc "Test double: same as ReviewDouble but search_foods returns empty for the unknown ingredient's guess."
  @behaviour InstaMealie.Mealie

  @impl true
  def create_recipe(_recipe), do: {:ok, "review-zero-slug"}
  @impl true
  ...
  @impl true
  def search_foods("mystery-spice"), do: {:ok, []}
  def search_foods(_term), do: {:ok, ["paprika", "cumin"]}
