defmodule InstaMealie.Test.MealieReviewValidationDouble do
  @moduledoc "Test double: same as ReviewDouble but create_recipe fails with a validation error."
  @behaviour InstaMealie.Mealie

  @impl true
  def create_recipe(_recipe), do: {:error, :validation, "rejected"}
  @impl true
