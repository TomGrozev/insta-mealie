...
#
#     PHX_SERVER=true bin/insta_mealie start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :insta_mealie, InstaMealieWeb.Endpoint, server: true
end
  ...
  config :insta_mealie, InstaMealieWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/insta_mealie_web/router\.ex$"E,
        ~r"lib/insta_mealie_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :insta_mealie, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :insta_mealie, InstaMealie.Mailer,
