...
If you encounter any issues using InstaMealie, try one of the
...
- **Ideas** - Ideas for new functionality that isn't yet ready for a formal
  feature request
- **Q&A** - Request help with installing or using InstaMealie

## Reporting Bugs

- First, ensure that you're running the [latest commit on `main`](https://github.com/TomGrozev/insta-mealie)
  of InstaMealie. If you're running an older version, it's possible that the bug
  has already been fixed.

- Next, check the GitHub [issues list](https://github.com/TomGrozev/insta-mealie/issues)
  to see if the bug you've found has already been reported. If you think you may
  be experiencing a reported issue that hasn't already been resolved, please
  click "add a reaction" in the top right corner of the issue and add a thumbs
  up (+1). You might also want to add a comment describing how it's affecting your
  setup. This will allow us to prioritize bugs based on how many users are
  affected.

- When submitting an issue, please be as descriptive as possible. Be sure to
  provide all information request in the issue template, including:

      * The environment in which InstaMealie is running
...
- First, check the GitHub [issues list](https://github.com/TomGrozev/insta-mealie/issues)
...
- Before filing a new feature request, consider raising your idea in a
  [GitHub discussion](https://github.com/TomGrozev/insta-mealie/discussions)
...
- When submitting a pull request, please be sure to work off of the `main`
  branch. All pull requests should target `main`.
...
- All code submissions should meet the following criteria (CI will enforce
  ...
  You can run every check locally in one go with `mix precommit`, which runs
  `compile --warnings-as-errors`, `deps.unlock --unused`, `format`, `credo`,
  `doctor --summary`, `sobelow`, and `test`.
